...
namespace implemented
{
    ...
    public:
        ...
        Camera_hw(const glm::vec3& position, const glm::vec3& center, const glm::vec3& up)
        {
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            glm::vec4 result = glm::rotate(glm::mat4(1.0f), angle, right) * glm::vec4(forward, 1);
            forward = glm::normalize(glm::vec3(result));
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            glm::vec4 result = glm::rotate(glm::mat4(1.0f), angle, -forward) * glm::vec4(right, 1);
            forward = glm::normalize(glm::vec3(result));
