...
void Lab7::Update(float deltaTimeSeconds)
{
    ...
    //     modelMatrix = glm::rotate(modelMatrix, RADIANS(270.0f), glm::vec3(1, 0, 0));
    //     RenderSimpleMesh(meshes["tanc"], shaders["LabShader"], modelMatrix, glm::vec3(0,1,0));
    // }
    //  {
    //     glm::mat4 modelMatrix = glm::mat4(1);
    //     modelMatrix = glm::translate(modelMatrix, glm::vec3(-0.65, 0.37, -0.54));
    //     modelMatrix = glm::scale(modelMatrix, glm::vec3(0.02f));
    //     modelMatrix = glm::rotate(modelMatrix, RADIANS(270.0f), glm::vec3(1, 0, 0));
    //     RenderSimpleMesh(meshes["turela"], shaders["LabShader"], modelMatrix, glm::vec3(0, 255, 0));
    // }
    // {
    //     glm::mat4 modelMatrix = glm::mat4(1);
    //     modelMatrix = glm::translate(modelMatrix, glm::vec3(-0.5, 0, -0.7));
    //     modelMatrix = glm::scale(modelMatrix, glm::vec3(0.02f));
    //     modelMatrix = glm::rotate(modelMatrix, RADIANS(270.0f), glm::vec3(1, 0, 0));
    //     RenderSimpleMesh(meshes["senila"], shaders["LabShader"], modelMatrix, glm::vec3(245,245,220));
    // }
    // {
    //     glm::mat4 modelMatrix = glm::mat4(1);
    //     modelMatrix = glm::translate(modelMatrix, glm::vec3(-0.5, 0, -1.07));
    //     modelMatrix = glm::scale(modelMatrix, glm::vec3(0.02f));
    //     modelMatrix = glm::rotate(modelMatrix, RADIANS(270.0f), glm::vec3(1, 0, 0));
    //     RenderSimpleMesh(meshes["senila"], shaders["LabShader"], modelMatrix, glm::vec3(192,192,192));
    // }

    // {
    //     glm::mat4 modelMatrix = glm::mat4(1);
    //     modelMatrix = glm::translate(modelMatrix, glm::vec3(-0.74, 0.4, -0.79));
    //     modelMatrix = glm::scale(modelMatrix, glm::vec3(0.02f));
    //     modelMatrix = glm::rotate(modelMatrix, RADIANS(270.0f), glm::vec3(1, 0, 0));
    //     RenderSimpleMesh(meshes["tun"], shaders["LabShader"], modelMatrix, glm::vec3(192,192,192));
    // }
    ...
    // Render ground
    {
        ...
        RenderSimpleMesh(meshes["plane"], shaders["LabShader"], modelMatrix, glm::vec3(0.5, 0.5, 0));
    }
