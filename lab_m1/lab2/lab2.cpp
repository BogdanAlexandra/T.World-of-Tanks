...
void Lab2::Init()
{
    ...
    vector<VertexFormat> vertices1{
     ...
     VertexFormat(glm::vec3(1, 0,  1), glm::vec3(1, 0, 1)),
     VertexFormat(glm::vec3(0, 0,  1), glm::vec3(1, 0, 1)),
     VertexFormat(glm::vec3(0.3f, 0.5f,  0.3f), glm::vec3(1, 0, 1))
 };
 ...
 vector<unsigned int> indices1 = {
    ...
    vector<VertexFormat> vertices2{
     ...
     VertexFormat(glm::vec3(0, 0,  2), glm::vec3(1, 1, 1)),
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(1.5f, 1.1f, 0.9), glm::vec3(0.25f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(1.9f, 1.2f, 0.8), glm::vec3(0.25f));
